...
# 1.1)при касании боковых стен меняет координату X вектора скорости на противоположную
# 1.2)при касании верхней или нижней стены меняет координату Y вектора скорости на противоположную
